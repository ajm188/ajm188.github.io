...
events (the other being <a href="http://acm.case.edu/acm/conference">Link
State</a> in the Fall) to get all the lessons we learned down in writing
while they are still fresh in our minds. This has been an incredibly
valuable thing for us to do, since we end up with a checklist of do's and
don'ts to reference when we plan for next year, and we avoid re-learning
...
again to start the clean-up (with assistance from <strong>awesome</strong>
alumni and volunteers) during the closing ceremonies. Oftentimes, a hacker
would approach me with a question, and I would have absolutely no idea how
to answer her question - I either had to ask a nearby volunteer, or turn to
our Slack.
...
moment to step back and ask yourself "is it <em>really</em> a big deal if
...
can plan all you like, but something <strong>will always go wrong</strong>,
and you need to take that in stride and not worry about it." I may not have
been the one to say it, but I wholeheartedly agree, and I watched this
happen time and again throughout the weekend.
...
### The Hour Gets Late and Everything Else Gets Weird
    ...
    in <a href="http://engineering.case.edu/thinkbox/">think[box]</a>. By this
    ...
    <strong>I spent a horrible amount of time writing
    fish</strong>. Ordinarily, I love my <a href="http://fishshell.com">fish
    shell</a>, but sorting out fish-specific issues late into the night quickly
    became increasingly frustrating. Luckily, I stuck it out
    and <a href="https://github.com/zquestz/s/pull/91">this pull request</a> is
    the final result. The overall eighty-three
    lines{% include sidenote.html id="sn-coding-is-hard" content="
    Yes - hours and hours for only eighty-three lines of working code! Computers defy me
    sometimes. Programming is hard." %} add some pretty cool completions for
    the <code>s</code> utility in fish. Go voice your opinion if you want to
    see the PR merged!

    <strong>Stephen wrote a horrible amount of
    JavaScript</strong>. <a href="http://stephen-brennan.com">Stephen</a> had
    the brilliant (for some definition of brilliant) idea to spend the night
    writing his <a href="https://github.com/brenns10/regex">regular expression
    library</a> (originally in C) in JavaScript. Now, Stephen spends much more
    time in languages like C than in
    the <a href="https://youtu.be/Wa5B22KAkEk">young, wild and free</a>
    ...
    <blockquote class="twitter-tweet" data-lang="en">
      <p lang="en" dir="ltr">
        &quot;This proves that JavaScript doesn&#39;t require a brain!&quot;
        - <a href="https://twitter.com/brenns10">@brenns10</a>
        <a href="https://twitter.com/hashtag/HackCWRU?src=hash">#HackCWRU</a>
      </p>
      &mdash; Andrew Mason (@andrew_mason1)
      <a href="https://twitter.com/andrew_mason1/status/698764609747034113">
        February 14, 2016
      </a>
    </blockquote>
    ...
    <strong>Things happened on Twitter</strong>. First, I lost all faith in the
    ...
    <blockquote class="twitter-tweet" data-lang="en">
      <p lang="en" dir="ltr">
        At this point, I just have no idea how computers work
      </p>
      &mdash; Andrew Mason (@andrew_mason1)
      <a href="https://twitter.com/andrew_mason1/status/698646325097840640">
        February 13, 2016
      </a>
    </blockquote>
    <script async src="//platform.twitter.com/widgets.js"
    ...
    <blockquote class="twitter-tweet" data-lang="en">
      <p lang="en" dir="ltr">
        &quot;RST is like TCP&#39;s safe word&quot; -
        <a href="https://twitter.com/brenns10">@brenns10</a>
        <a href="https://twitter.com/hashtag/HackCWRU?src=hash">#HackCWRU</a>
      </p>
      &mdash; Andrew Mason (@andrew_mason1)
      <a href="https://twitter.com/andrew_mason1/status/698770343926878208">
        February 14, 2016
      </a>
    </blockquote>
    <script async src="//platform.twitter.com/widgets.js"
    ...
    <blockquote class="twitter-tweet" data-lang="en">
      <p lang="en" dir="ltr">
        Take a few hours of sleep away from me, and I revert to the behavior of
        a five-year
        old. <a href="https://twitter.com/hashtag/HackCWRU?src=hash">#HackCWRU</a>
      </p>&mdash; Andrew Mason (@andrew_mason1)
      <a href="https://twitter.com/andrew_mason1/status/698771587072442368">
        February 14, 2016
      </a>
    </blockquote>
    <script async src="//platform.twitter.com/widgets.js"
    ...
    <blockquote class="twitter-tweet" data-lang="en">
      <p lang="en" dir="ltr">
        Voodoo twitternomics will lead to a snack overflow
        <a href="https://t.co/uETXPEgXAb">https://t.co/uETXPEgXAb</a>
      </p>&mdash; Andrew Mason (@andrew_mason1)
      <a href="https://twitter.com/andrew_mason1/status/698773020010225664">
        February 14, 2016
      </a>
    </blockquote>
    <script async src="//platform.twitter.com/widgets.js"
    ...
    <strong>We called <a href="http://stephhippo.com/">Steph</a></strong>. She
    "had to be in Seattle for work," and we didn't want her to miss out. She
    quickly became concerned about our health and sanity, but was too
    entertained by the ludicrousness of it all to make a serious attempt to
    corral us.

    <strong>I figured out my MATLAB homework</strong>. We were working with
    ...
    typecast that the homework document <em>told us was necessary</em> and the
...
### The Endless Night Ends
    ...
    finally came to an end. Morning had come. Zach and I ran off to Starbucks
    to pick up a large coffee order we placed. There, we learned that we had
    purchased ten gallons of coffee. In case you are wondering how much coffee
    ten gallons of coffee actually is, it's <strong>a lot</strong> of
    coffee. We also learned that bulk coffee at Starbucks runs at $18/gallon,
    so think about that the next time you complain about gas
    prices.
    ...
    sleep.{% include sidenote.html id="sn-irrational" content="
    nap. How's that for rational decision-making?" %} A few other
    volunteers stayed behind with me to jump-start the cleaning as well. So,
    while we cleaned, I got to spend time catching up with Dave, who I had not
    seen since the last time he rolled into Cleveland for a visit (which I
    think was October, but my memory does not work right now).
    ...
    annoying). Dave <s>suggested</s> ordered me to go home. But, I had to wait
    for the last coffee pot so that I could return them to Starbucks. This
    took <strong>forever</strong> (in my mind).

    Finally, the last coffee pot appeared and
    David{% include sidenote.html id="sn-david-dave" content="This David
    is a different one. It's not Dave. Keep up, will you?" %} came with me
    to bring them back to Starbucks. We agreed that I would drop him back off
    so he could help finish packing up, and I would just go home, since I was
    more of an annoyance than I was helpful. I got lost multiple times bringing
    David back. Honestly, I probably shouldn't have been driving, but we made
    it back safely, and I finally returned to my dorm. I then finished up some
    work I needed to do for senior project (due tomorrow), and then began
    writing this post after taking a <em>much needed shower</em>.

<section>
  <h2>Oh, Yeah. <a href="{% link _posts/2016-02-12-hack-cwru-16.html %}">I Had Goals</a></h2>

  <p>
    That's right! I almost forgot (wink, wink; nudge, nudge). Setting goals
    seems to be a pointless exercise unless you remember to go back and
    actually evaluate how much of what you set out to do was actually
    accomplished. I think that it's also important to think about <em>why</em>
    you either met or failed to meet a certain goal. Simply setting a goal for
    yourself does not necessarily mean that that's what you should focus on
    above everything else. Unless you can predict the future (in which case,
    send me an email - let's chat), some of your goals are bound to be pretty
    poor, and some are bound to be flat-out wrong.
  </p>
  ...
  <ol style="width: 100%;">
    <li><strong>Get my homework done</strong>.
      <p>
    ...
    <li><strong>Get back into meditation</strong>.
      <p>
    ...
    <li>
      <strong>Contribute to some open source</strong>.
      ...
      <p><strong>Get issue counts down on my repositories</strong>.</p>
      <p>
      ...
      <p><strong>Fish completion for <code>s</code></strong>.</p>
      <p>
      ...
      <p><strong>Slackbot Spotify integration</strong>.</p>
      <p>
        ...
        taken <em>much longer</em> than my work on <code>s</code>, and that
...
<section>
  ...
  <p>
    ...
    the <a href="http://static.giantbomb.com/uploads/original/0/340/704216-tauntaun.jpg">cold</a>
